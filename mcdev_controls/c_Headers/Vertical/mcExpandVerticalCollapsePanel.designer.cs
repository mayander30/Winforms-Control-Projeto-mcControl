using mcdev_controls.c_Generic;
namespace mcdev_controls.c_Headers.Vertical
{
    partial class mcExpandVerticalCollapsePanel
    {
        ...
        {
            this.lblHeader = new mcdev_controls.c_Generic.mcLabelVertical();
            this._btnExpandCollapse = new mcdev_controls.c_Headers.Vertical.ExpandVerticalCollapseButton();
            this.SuspendLayout();
            // 
            // lblHeader
            // 
            ...
            this._btnExpandCollapse.ButtonSize = mcdev_controls.c_Headers.Vertical.ExpandVerticalCollapseButton.ExpandButtonSize.Small;
            this._btnExpandCollapse.ButtonStyle = mcdev_controls.c_Headers.Vertical.ExpandVerticalCollapseButton.ExpandButtonStyle.Normal;
